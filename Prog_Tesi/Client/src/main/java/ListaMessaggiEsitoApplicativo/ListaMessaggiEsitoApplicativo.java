...
public class ListaMessaggiEsitoApplicativo {
	 private int numRisultati ;
	    ...
	    @JsonProperty("infoEsitoApplicativo")
	    private List<infoEsitoApplicativo> l= new ArrayList<>();
	    
	    public ListaMessaggiEsitoApplicativo(){}
	    
		public ListaMessaggiEsitoApplicativo(int numRisultati, int numPagine, int risultatiPerPagina, int pagina,
				String dataUploadDa, String dataUploadA, List<infoEsitoApplicativo> l) {
			super();
		...
		public List<infoEsitoApplicativo> getL() {
			return l;
		}

		public void setL(List<infoEsitoApplicativo> l) {
			this.l = l;
		}
