...
public class ListaDisponibilitaLiquide {
    ...
    @JsonProperty("infoDisponibilita")
    private List<infoDisponibilita> l= new ArrayList<>();
    
    public ListaDisponibilitaLiquide(){}
    
    
	public ListaDisponibilitaLiquide(int numRisultati, int numPagine, int risultatiPerPagina, int pagina,
			String dataUploadDa, String dataUploadA, List<infoDisponibilita> l) {
		super();
	...
	public List<infoDisponibilita> getL() {
		return l;
	}


	public void setL(List<infoDisponibilita> l) {
		this.l = l;
	}
