...
public class ListaGiornaliDiCassa {
	 private int numRisultati ;
	    ...
	    @JsonProperty("infoGiornali")
	    private List<infoGiornali> l= new ArrayList<>();
	    
	    public ListaGiornaliDiCassa() {}
	    
		public ListaGiornaliDiCassa(int numRisultati, int numPagine, int risultatiPerPagina, int pagina,
				String dataUploadDa, String dataUploadA, List<infoGiornali> l) {
			super();
		...
		public List<infoGiornali> getL() {
			return l;
		}

		public void setL(List<infoGiornali> l) {
			this.l = l;
		}
